...
//Verificar si hay libros en espanol
...
// Verificar si hay libros de ciencia ficcion
...
int main() {
	...
	do {
		...
		cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
			<< "\n\t3) Eliminar libro\n\t4) Buscar Libro"
			<< "\n\t5) Hay libros en espanol?"
			<<"\n\t6) Hay libros de Ciencia Ficcion? "
			<< "\n\t7) Elimina libros de misterio "
			<< "\n\t8) Salir\n\tOpcion elegida: ";
		cin >> opcion;
		switch (opcion) {
		...
		case 5:
			if (buscarLibroEspanol())
				cout << "SI se encuentran libros en espanol!" << endl;
			else
				cout << "NO se encuentran libros en espanol :(" << endl;
		break;
		case 6: 
			if (buscarLibroCienciaFiccion())
				cout << "SI se encuentran libros de ciencia ficcion!" << endl;
			else
				cout << "NO se encuentran libros de ciencia ficcion :(" << endl;
			break;
		case 7: 
			cout << eliminarMisterio << endl;
			cout << "Los libros de misterio se han borrado." << endl;
			break;
